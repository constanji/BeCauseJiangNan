...
public final class FactoryUtil {
    ...
    public static ContentStore createContentStore(@NonNull String storeId,
        ...
        EmbeddingStore<TextSegment> lightSchemaEmbeddingStore = createEmbeddingStore(
                storeId, ContentType.LIGHT_SCHEMA, embeddingStoreFactoryDescriptor);
        EmbeddingStore<TextSegment> cellEmbeddingStore = createEmbeddingStore(
                storeId, ContentType.CELL, embeddingStoreFactoryDescriptor);
        EmbeddingStore<TextSegment> indexEntryEmbeddingStore = createEmbeddingStore(
                storeId, ContentType.INDEX_ENTRY, embeddingStoreFactoryDescriptor);
        ...
        try {
            return factory.create(factoryDescriptor.getConfig(), embeddingModel,
                    sqlEmbeddingStore, synEmbeddingStore, docEmbeddingStore,
                    lightSchemaEmbeddingStore, cellEmbeddingStore, indexEntryEmbeddingStore,
    ...
    public static AskdataAgent createAskdataAgent(@NonNull FactoryDescriptor factoryDescriptor,
        ...
        List<ChatModelInstance> chatModelInstances = chatModelFactoryDescriptors.entrySet().stream()
                ...
                .collect(Collectors.toList());
        try {
            return factory.create(factoryDescriptor.getConfig(), contentStore,
    ...
    public static AskdataAgent createAskdataAgent(@NonNull FactoryDescriptor factoryDescriptor,
                                                  ...
                                                  @NonNull Map<String, FactoryDescriptor> chatModelFactoryDescriptors,
                                                  @NonNull FactoryDescriptor databaseAdapterFactoryDescriptor) {
        return createAskdataAgent(factoryDescriptor, contentStore,
