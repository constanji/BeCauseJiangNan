...
export type AgentChartConfig = {
  ...
  match_rules?: AgentChartMatchRules;
};

export type AgentChartMatchRules = {
  time_series?: {
    enabled?: boolean;
    chart_type?: 'line' | 'bar';
    min_periods?: number;
...
export type Agent = {
  ...
  auto_chart?: boolean;
  /** echarts_generator_app behavior config; undefined means legacy protocol (see auto_chart for the enable gate) */
