...
const { isEnabled, checkEmailConfig, isEmailDomainAllowed } = require('@because/api');
const { ErrorTypes, SystemRoles, errorsToString } = require('@because/data-provider');
const {
  findUser,
  findToken,
  createUser,
...
const sendVerificationEmail = async (user) => {
  ...
  await sendEmail({
    ...
    payload: {
      appName: process.env.APP_TITLE || 'Because',
